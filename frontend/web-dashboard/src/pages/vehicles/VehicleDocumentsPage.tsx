...
export default function VehicleDocumentsPage() {
  ...
  const [docType, setDocType] = useState<DocType>('VehicleRegistration');
  ...
  const handleUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Reset form
      setFile(null);
      setDocType('VehicleRegistration');
      setIssueDate('');
      setExpiryDate('');
      // Invalidate query
            ...
            <div className="bg-white border border-black/[0.08] rounded-lg shadow-sm overflow-hidden min-h-[400px]">
              ...
              {isLoadingDocs ? (
                ...
                <div className="p-12 text-center text-[#6E6E80] flex flex-col items-center">
                  ...
                  <p className="text-xs mt-1">Use the form to upload registration or insurance.</p>
                </div>
              ) : (
