...
def fix_all():
    ...
    for cmd in db_commands:
        stdin, stdout, stderr = client.exec_command(f"docker exec mesiri-postgres psql -U mesiri -c \"{cmd}\"")
...
"""
    ...
    print("Done! Tell the user to visit https://mercon.tech/mesiriadmin (it should now redirect/work).")
