...
def deploy_v2():
    ...
    try:
        ...
        for cmd in db_commands:
            ...
            stdin, stdout, stderr = client.exec_command(f"docker exec mesiri-postgres psql -U postgres -c \"{cmd}\"")
...
"""
        ...
        stdin, stdout, stderr = client.exec_command(f"grep -q 'location /mesiriadmin/' {CONFIG_PATH} && echo 'EXISTS' || echo 'MISSING'")
