...
out, _ = run(
    client,
    "find /opt/mesiri -name 'mesiri' -type d 2>/dev/null | grep -v venv | grep -v __pycache__",
)
print(out)
...
out, _ = run(
    client,
    "cat /opt/mesiri/.venv/lib/python3.12/site-packages/__editable___mesiri_runtime_0_1_0_finder.py",
)
print(out)
