...
class ProjectResponse(BaseModel):
    ...
    reportingTimezone: str = Field("UTC", alias="reportingTimezone")
    reportingCutoffTime: str = Field("18:00", alias="reportingCutoffTime")
    autoGenerateDpr: bool = Field(False, alias="autoGenerateDpr")
    requiredReportTypes: list[str] | None = Field(None, alias="requiredReportTypes")
